...
import { User, UserRole, UserProfile, VacationLog, Employee, Team, HealthRecord, ScheduleEvent, ScheduleTemplate } from './types';
...
export const INITIAL_EMPLOYEES: Employee[] = [
  { id: 'HR001', name: '김유연', engName: 'Jenny Kim', dept: 'People & Culture', role: 'Senior Manager', workStatus: '출근', email: 'jenny@company.com', phone: '010-1234-5678', joinDate: '2019-03-15', avatarUrl: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80', nickname: '제니', rank: '팀장 / Level 5' },
  { id: 'LP125', name: '이채연', engName: 'Sophia Lee', dept: 'Platform Squad', role: 'Product Owner', workStatus: '출근', email: 'sophia@company.com', phone: '010-9876-5432', joinDate: '2022-01-10', avatarUrl: 'https://picsum.photos/id/64/200/200', nickname: '소피아', rank: '매니저 / Level 3' },
  { id: 'DV022', name: '박지성', engName: 'Jisung Park', dept: 'Engineering', role: 'Frontend Dev', workStatus: '휴가', email: 'park@company.com', phone: '010-1111-2222', joinDate: '2021-05-20', avatarUrl: 'https://picsum.photos/id/10/200/200', nickname: '지성', rank: '시니어 / Level 4' },
  { id: 'DV023', name: '손흥민', engName: 'Sonny', dept: 'Engineering', role: 'Backend Dev', workStatus: '퇴근', email: 'son@company.com', phone: '010-3333-4444', joinDate: '2021-06-01', avatarUrl: 'https://picsum.photos/id/55/200/200', nickname: '쏘니', rank: '시니어 / Level 4' },
  { id: 'MK005', name: '이강인', engName: 'Kangin Lee', dept: 'Marketing', role: 'Marketer', workStatus: '병가', email: 'lee@company.com', phone: '010-5555-6666', joinDate: '2023-01-01', avatarUrl: 'https://picsum.photos/id/33/200/200', nickname: '강인', rank: '주니어 / Level 2' },
  { id: 'DV024', name: '김민재', engName: 'Minjae Kim', dept: 'Engineering', role: 'DevOps', workStatus: '출근', email: 'kim@company.com', phone: '010-7777-8888', joinDate: '2022-08-15', avatarUrl: 'https://picsum.photos/id/100/200/200', nickname: '몬스터', rank: '매니저 / Level 3' },
];
