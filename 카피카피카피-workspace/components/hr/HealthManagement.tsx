...
import { Search, X, FileText, Download, Calendar, User, Activity, ArrowRight, Trash2, Edit3, CheckCircle2, AlertTriangle, AlertCircle, RefreshCw } from 'lucide-react';
                ...
                <div className="flex items-center gap-3">
                    <div className="relative">
                        ...
                        <input 
                            ...
                            className="pl-9 pr-4 py-2 text-sm border border-gray-200 rounded-lg w-64 focus:outline-none focus:border-black transition-colors shadow-sm" 
                        />
                    </div>
