...
public class BoardController {
    ...
    @GetMapping("/{boardId}")
    public ResponseEntity<BoardResponse.DetailDto> getBoard(@PathVariable String boardId){
    ...
    @PostMapping
    public ResponseEntity<String> createBoard(@ModelAttribute BoardRequest.CreateDto request, @RequestParam("upfile") MultipartFile upfile) throws IOException {
