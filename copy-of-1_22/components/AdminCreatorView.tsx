          ...
          <div className="max-w-[1600px] mx-auto">
              ...
              <div className="mb-8">
                  ...
                  <div className="flex gap-6 border-b border-gray-200 mt-6">
                      <button onClick={() => setAdminTab('list')} className={`pb-3 text-sm font-medium transition-colors flex items-center gap-2 ${adminTab === 'list' ? 'border-b-2 border-black text-black' : 'text-gray-400 hover:text-gray-700'}`}>
                         <Users size={16} /> 목록 관리
                      </button>
                      <button onClick={() => setAdminTab('contract')} className={`pb-3 text-sm font-medium transition-colors flex items-center gap-2 ${adminTab === 'contract' ? 'border-b-2 border-black text-black' : 'text-gray-400 hover:text-gray-700'}`}>
                         <FileText size={16} /> 계약 관리
                      </button>
                      <button onClick={() => setAdminTab('health')} className={`pb-3 text-sm font-medium transition-colors flex items-center gap-2 ${adminTab === 'health' ? 'border-b-2 border-black text-black' : 'text-gray-400 hover:text-gray-700'}`}>
              ...
              {/* ADMIN ADD/EDIT MODAL - Removed Profile Image Upload as per Policy */}
              {isAddModalOpen && (
