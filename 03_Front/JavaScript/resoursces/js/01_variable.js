...
//.log() console객체의 메서드 중 하나로 메세지를 출력 -> 개발자도구에 console영역에 표시됨.
 ...
 * 2) 특수문자는 언더스코어와(_)와 달러($)를 사용할 수 있음.
 * 3) 키워드를 변수명으로 사용하면 안됨.
 * 4) 숫자로 시작하면 안됨.
 * 
 * 일반적으로 변수명,함수명 -> camelCase ex)javaScriptNode
...
/**
 * null
 * undefinde와 동일하게 값이 없음을 표시
 * 다만 js에서는 개발자가 집접 명시적으로 없는 값을 초기화 할 때 사용
 */
...
const tmp1 = '1';
const tmp2 = '2';
console.log("tmp === tmp2 : ", tmp1 === tmp2);

const symbol1 = Symbol('1');
const symbol2 = Symbol('1');

console.log(symbol1, symbol2); // Symbol(1) Symbol(1)
...
//arry.pop() 맨 마지막에 추가됨 요소를 제거하고 반환한다.
console.log(arr.pop());
console.log(arr);
