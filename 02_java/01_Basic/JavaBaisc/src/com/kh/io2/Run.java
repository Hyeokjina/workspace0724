...
public class Run {
	 ...
	 * - 데이터를 순차적으로 흘려보내는 파이프 같은 구조.
	 * 
	 * 스트림의 특징
	 * 1.단방향 : 입력이면 입력반 출력이면 출력만 가능 -> 동시에 원하면 각각 만들어줘야한다.
	 ...
	 * 	 보조스트림 : 기반스트림을 감싸 성능 향상이나 기능추가 제공(단독사용불가, 반드시 기반스트림과 함께 사용)
	 */

	public static void main(String[] args) {
		//new SrveStream().fileSave();
		//new SrveStream().fileRead();
		//new SrveStream().ObjectSave();
		new SrveStream().ObjectRead();
	}
