...
public class For {
	/*
	 * <반복문>
	 * 특정 코드를 여러 번 반복해서 실행하고자 할때 사용하는 제어문.
	 * 
	 ...
	 * }
	 * 
	 * 초기식 : 반복을 시작하기 전에 변수를 선언하고 초기값을 설정, 처음 딱 한번만 실행됨.
	 * 
...
/*		for(int i=6; i>0; i--) {
		...
		//System.out.println(num-i); -> 블록내에 선언한 변수를 외부에서 사용할 수 없음.
		
		/*
		 * 초기식, 조건식, 증감식을 꼭 입력ㅎ야 하는 건 아니지만 
		...
		*/
		...
		//정수 n을 입력받아서 1부터 n까지 1씩 증가 시키면서 출력해라
		//정수입력 : n
		// 1 2 3 4 5
...
/*		System.out.print("아메리카노를 몇잔 구매하시겠습니까?(1100원) :");
		int coffe = sc.nextInt();
		int sum=0;
		
		for (int i=1; i<=coffe; i++) {
			sum += 1100;
		}
...
*/		
		 ...
		 * 
		 * Math.random() 호출시 -> 0.0~0.99999999999999사이의 랜덤값을 반환
		 * int num = (int)Math.random() -> 0~0
		 * int num = (int)(Math.random()*10)+1 -> 1~10;
		 * 최소값~최대값 랜덤 수 : (int)(Math.random() *(최대값 +1 - 최소값)) + 최소값;
		 * */
		
		//random(1~10)한 숫자 n 을 생성해서 1부터 n까지 모두 더한 값을 출력해라
		//random 수 : n
		//1~n까지의 합 : xxx
