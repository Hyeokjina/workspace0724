...
public class MemberMenu {
	...
	public void insertAllMember() {
		System.out.println("========= 회원 일괄 추가 ===========");
		System.out.print("추가 회원 수 : ");
		int num = sc.nextInt();
		sc.nextLine();
		for(int i = 1; i <= num; i++) {
			System.out.print(i+"번 추가 아이디 : ");
			String userId = sc.nextLine();
			
			System.out.print(i+"번 추가 비밀번호 : ");
			String userPwd = sc.nextLine();
			
			System.out.print(i+"번 추가 이름 : ");
			String userName = sc.nextLine();
			
			System.out.print(i+"번 추가 성별(M,F) : ");
			String gender = sc.nextLine();
			
			System.out.print(i+"번 추가 나이 : ");
			String age = sc.nextLine();
			
			System.out.print(i+"번 추가 이메일 : ");
			String email = sc.nextLine();
			
			System.out.print(i+"번 추가 전화번호(-제외) : ");
			String phone = sc.nextLine();
			
			System.out.print(i+"번 추가 주소 : ");
			String address = sc.nextLine();
			
			System.out.print(i+"번 추가 취미(,로 구분) : ");
			String hobby = sc.nextLine();
			
			mc.insertAllMember(userId, userPwd, userName, gender, age, email, phone, address, hobby);
		}
	}
