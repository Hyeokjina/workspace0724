...
public class MemberController {
	...
	public void updateMember(String userId, String email, String phone, String address, String hobby) {
		...
		Member m = new Member( userId,email, phone, address, hobby);
	...
	public void insertAllMember(String userId, String userPwd, String userName, String gender, String age, String email,
			String phone, String address, String hobby) {
		...
		int result = ms.insertAllMember(m);
