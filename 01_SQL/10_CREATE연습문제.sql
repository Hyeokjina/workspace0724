...
VALUES (1,'동화나라','010-5555-8888');
INSERT INTO TB_PUBLISHER
VALUES (2,'미래나라','010-5775-3388');
INSERT INTO TB_PUBLISHER
VALUES (3,'환상나라','010-5535-9520');
...
-- 샘플 5개 정도 생성
INSERT INTO TB_BOOK
VALUES (100,'백설공주','홍길동',15000,1);
INSERT INTO TB_BOOK
VALUES (101,'개미와 배짱이','이상화',17000,1);
INSERT INTO TB_BOOK
VALUES (102,'시골쥐서울쥐','김광현',15000,1);
INSERT INTO TB_BOOK
VALUES (103,'인어공주','김재현',11000,2);
INSERT INTO TB_BOOK
VALUES (104,'동백꽃','최지훈',16000,3);
SELECT * FROM TB_BOOK;
...
CREATE TABLE TB_MEMBER (
    ...
    MEMBER_ID         VARCHAR2(20) CONSTRAINT MEMBER_NN_ID NOT NULL CONSTRAINT MEMBER_UQ_ID UNIQUE,
    MEMBER_PWD        VARCHAR2(20) CONSTRAINT MEMBER_NN_PWD NOT NULL,
    MEMBER_NAME1      VARCHAR2(20) CONSTRAINT MEMBER_NN_NAME NOT NULL,
...
COMMENT ON COLUMN TB_MEMBER.MEMBER_NAME1 IS '회원명';
...
VALUES (200, '123AAA', 'A1', '김성현', 'M', '서울시', '010-1112-1111', 'N', '20/10/20');
INSERT INTO TB_MEMBER
VALUES (201, '123BBB', 'A2', '박재상', 'M', '인천시', '010-2222-1111', 'Y', '19/10/20');
INSERT INTO TB_MEMBER
VALUES (202, '123CCC', 'A3', '김민지', 'F', '서울시', '010-3333-1111', 'N', '20/10/20');
INSERT INTO TB_MEMBER
VALUES (203, '123DDD', 'A4', '정소라', 'F', '부산시', '010-4444-1111', 'Y', '24/10/20');
INSERT INTO TB_MEMBER
VALUES (204, '123EEE', 'A5', '최정',   'M', '대구시', '010-5555-1111', 'N', '21/10/20');
...
-- 샘플 3개 정도 생성
INSERT INTO TB_RENT
VALUES (300,200,100,'23/08/20');
INSERT INTO TB_RENT
VALUES (301,201,102,'25/10/20');
INSERT INTO TB_RENT
VALUES (302,202,103,'23/12/20');
