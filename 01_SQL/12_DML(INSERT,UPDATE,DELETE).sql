...
/*
    ...
    DML(MANIPULATION 테이터 조작어) : INSERT, UPDATE, DELETE
    DDL (DEFINITION 데이터 정의어) : CEEATE, ALTER, DROP
    DCL(CONNTROL 데이터 제어어) : GRANT, REVOKE
    TCL(TRANSACTION 트랜직션 제어어) : COMMIT, ROLLBACK
...
/*
    ...
    테이블의 모든 컬럼에 대한 값을 순서대로 제시해서 한 행을 INSERT하고자 할때 사용
...
VALUES(900,'김수민','888888-9999999','LSH133@NAVER.COM',01044444444,'D7','J5',4000000,0.2,200,SYSDATE,NULL,'N');
...
/*
    ...
    ->DEFAULT가 없고 NOT NULL제약조건이 걸려 있는 컬럼은 반드시 직접 값을 넣어줘야한다.
*/
...
/*
    ...
    VALUES에 직접 값을 명시하는 것이 아니라, 대신 서브커리로 조회된 값을 모두 INSERT가능
*/
CREATE TABLE EMP_01(
    EMP_ID NUMBER,
...
UPDATE DEPT_TABLE
    SET DEPT_TITLE ='광고기획팀'
WHERE DEPT_ID IN('D9','D8');
...
--박명수 사원의 급여와 보너스값을 유재식 사원의 급여와 보너스 값으로 변경
UPDATE EMP_SALARY
