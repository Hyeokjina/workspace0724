...
/*	Cake c1 = new CheeseCake();
	//Cake까지 접근가능하며 메모리공간은 실제 ChessesCake의 공간에 위치함
	c1.sweet();
	//오버라이딩시에는 실제 메모리에 재정의된 메스드가 호출됨.
	c1.yummy();
