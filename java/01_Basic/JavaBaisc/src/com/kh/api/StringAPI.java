...
public class StringAPI {
	public void method01() {
		...
		//그래서 참조변수 출력시 Object의 toString형식(타입@주소값16진수)이 이나라 String의 저장된 문자열이 반환됨.
		
		System.out.println(str1 == str2);
		//String객체의 주소값을 비교하기 때문에 false가 출력
	...
	public void method02() {
		...
		//문자열에 전달도니 문자열이 포함되어 있는지 확인하여 결과를 반환
		...
		//문자열에서 대상문자를 찾아서 변경할 문자로 대체한 후 변환된 문자열을 만환
	...
	public void method03() {
		String str = "Java,Oracle,sql,htm,css,js,spring";
		
		//구분자를 기준으로 문자열을 분리 시키는 방법
		//방법1. 분리된 문자열들을 String[]에 차곡차곡 담아야 할때 
		...
		System.out.println(stn.nextToken());
		System.out.println(stn.nextToken());
		//System.out.println(stn.nextToken()); 더 이상 토큰이 남아있지 않을 때 다음토큰 호출시 예외발생
