...
public class Run {
	 ...
	 * HashMap(가장보편적이고 속도향상), LinkedHashMap(입력순서보장), TreeManp(정렬된key순서유지)
	 */
	...
	public static void main(String[] args) {
		...
		hMap.put(40, new Human("최지오",60));//동일한 key사용시 값이 덮어씀
		System.out.println(hMap);//저장되는 순서 유지안됨!
		...
		Set keySet = hMap.keySet();	//모든 키를 Set에 담아서 반환
		...
		//Map은 key와 value를 쌍으로 저장하기 때문에 단순하에 keySet(), values()만으로는 
